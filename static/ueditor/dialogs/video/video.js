...
(function(){
    ...
    function createPreviewVideo(url){
        ...
        if(ext=='mp3' || ext=='ogg'){
            //当前插入的是音频文件
            $G("preview").innerHTML ='<audio' + ' class="previewVideo" ' +
            ' controls preload="auto" controls width="420" height="280" src="' + conUrl + '" data-setup="{}">' +
            '<source src="' + conUrl + '" type="audio/' + ext + '" />'+lang.urlError+'</audio>';
        
        }else{
            //当前插入的是视频文件
            $G("preview").innerHTML ='<video' + ' class="previewVideo" ' +
            ' controls preload="auto" controls width="420" height="280" src="' + conUrl + '" data-setup="{}">' +
            '<source src="' + conUrl + '" type="video/' + ext + '" />'+lang.urlError+'</video>';
        }
